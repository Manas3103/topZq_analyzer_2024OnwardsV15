...
config = {
        ...
        # NEW: which analyser class to instantiate at runtime
        # must match the exact C++ class name exposed to ROOT via cppyy
        'analysertype': 'FakeFactorAnalyser',   # or 'FakeFactorAnalyser', etc.
...
nanoaod_inputdir_outputdir_pairs = [
    ['/QCD_Bin-PT-80to120_Fil-MuEnriched_TuneCP5_13p6TeV_pythia8/RunIII2024Summer24NanoAODv15-150X_mcRun3_2024_realistic_v2-v2/NANOAODSIM',
     'QCD_Bin-PT-80to120_Fil-MuEnriched.root',
     'QCD_Bin-PT-80to120_Fil-MuEnriched.out']
    ]
